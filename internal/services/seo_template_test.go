...
func TestSEOTemplateFunctions(t *testing.T) {
	funcMap := GetTemplateFuncMap()

	// Test generateJsonLD function
	t.Run("generateJsonLD", func(t *testing.T) {
	...
	// Test renderMetaTags function
	t.Run("renderMetaTags", func(t *testing.T) {
	...
	// Test seoExcerpt function
	t.Run("seoExcerpt", func(t *testing.T) {
	...
	// Test readingTime function
	t.Run("readingTime", func(t *testing.T) {
	...
	t.Run("buildURL", func(t *testing.T) {
		...
		expected := "https://example.com/article/test"
		if result != expected {
...
func TestJSONLDValidation(t *testing.T) {
	...
	complexData := map[string]interface{}{
		...
		"mainEntityOfPage": map[string]interface{}{
			"@type": "WebPage",
			"@id":   "https://example.com/article/test",
		},
		"image": []string{
